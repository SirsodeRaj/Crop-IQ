          ...
          <div className="relative flex min-h-screen flex-col">
            ...
            <footer className="w-full border-t border-slate-200 py-8 mt-12 bg-white/50 backdrop-blur-sm">
              <div className="container mx-auto px-4 flex flex-col items-center gap-4">
                ...
                {/** Ankita */}
                <a
                  href="https://github.com/Ankitasolankar"
                  target="_blank"
                ...
                >
                  ...
                  <span className="font-medium text-sm">Ankita</span>
                </a>

              {/** Bhagyashree */}
              <a
                  href="https://github.com/bhagyashreekathar-214018"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center gap-2 px-4 py-2 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-700 transition-all hover:scale-105"
                >
                  ...
                  <span className="font-medium text-sm">Bhagyashree</span>
                </a>
              ...
              {/** Raj */}
                ...
                >
                  ...
                  <span className="font-medium text-sm">Raj</span>
                </a>

              {/** Vanshika */}
              <a
                  href="https://github.com/vanshikasawalikar-droid"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center gap-2 px-4 py-2 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-700 transition-all hover:scale-105"
                >
                  ...
                  <span className="font-medium text-sm">Vanshika</span>
                </a>
              </div>
              </div>
            </footer>
